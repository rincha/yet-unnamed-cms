...
define(
  ...
  function () {
    ...
    var getExtendedButtons = function (editorSettings) {
      return editorSettings.link_extended_buttons;
    };
    ...
    return {
      ...
      getExtendedButtons: getExtendedButtons,
...
define(
  ...
  function (Delay, Tools, XHR, Utils, Settings) {
    ...
    var showDialog = function (editor, linkList) {
      ...
      var win, onlyText, textListCtrl, linkListCtrl, extendedButtons, relListCtrl, targetListCtrl, classListCtrl, linkTitleCtrl, value;
      ...
      if (Settings.getExtendedButtons(editor.settings)) {
        extendedButtons=Settings.getExtendedButtons(editor.settings)
        for (var i in extendedButtons) {
            body.push(extendedButtons[i]);
        }
      }
...
define(
  ...
  function (PluginManager, Actions, Controls) {
    PluginManager.add('rlink', function (editor) {
...
dem('tinymce.plugins.rlink.Plugin')();
})();
